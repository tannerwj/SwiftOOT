    ...
    func testExtractWritesPackedBinaryForDecimalAndHexVertexMacros() throws {
        ...
        try harness.writeSource(
            ...
            Vtx sceneName_Vtx_0000[] = {
                VTX(-1, 0x0002, 3, 0, -4, 0x7FFF, 0x10, 32, 48, 0xFF),
                VTX(0xFFFE, -8, 9, 0x8000, 0xFFF0, 16, 1, 2, 3, 4),
            };
            """
        )
        ...
        XCTAssertEqual(
            ...
            [
                ...
                0xFF, 0xFC, 0x7F, 0xFF, 0x10, 0x20, 0x30, 0xFF,
                0xFF, 0xFE, 0xFF, 0xF8, 0x00, 0x09, 0x80, 0x00,
                0xFF, 0xF0, 0x00, 0x10, 0x01, 0x02, 0x03, 0x04,
            ]
        )
    }
