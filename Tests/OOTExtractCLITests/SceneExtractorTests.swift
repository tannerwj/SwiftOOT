...
final class SceneExtractorTests: XCTestCase {
    ...
    private func makeFixtureSource() throws -> URL {
        ...
        try write(sceneSourceFixture, to: sceneDirectory.appendingPathComponent("spot04_scene.c"))
        try write(roomSourceFixture, to: sceneDirectory.appendingPathComponent("spot04_room_0.c"))
