...
final class OOTDataModelTests: XCTestCase {
    ...
    func testFoundationalModelsSatisfyCodableAndSendableConstraints() {
        ...
        assertCodableAndSendable(SceneSkyboxFace.self)
        assertCodableAndSendable(SceneSkyboxFaceAsset.self)
        assertCodableAndSendable(SceneSkyboxAssetState.self)
        assertCodableAndSendable(SceneSkyboxScheduleEntry.self)
        assertCodableAndSendable(SceneResolvedSkybox.self)
        ...
        assertCodableAndSendable(SceneCutsceneTrigger.self)
        assertCodableAndSendable(SceneEventRegionTrigger.self)
        assertCodableAndSendable(SceneCylinderTriggerVolume.self)
